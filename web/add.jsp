<%-- 
    Document   : add
    Created on : 5 Jul, 2023, 11:59:46 AM
    Author     : acer
--%>
...
<html>
    ...
    <div class="container-fluid shadow h-60 w-50 p-3 mb-5 bg-white rounded">                  
        <form  action="addbookform.jsp" method="post" onsubmit="Do you want to submit?">
           ...
           <div class="form-group my-3 ">
            ...
            <div class="form-group my-3">
                    <label for="exampleInputEmail1"class="text-primary">Upload Cover Photo*</label>
